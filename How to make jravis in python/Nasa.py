...
def NasaNews(Date):
    ...
    Path_2 = "C:\\Users\\parth\\Desktop\\How to make jravis in python\\DataBase\\NasaDataBase\\" + str(FileName)
...
def Summary(Boby):
    ...
    path = "C:\\Users\\parth\\Desktop\\How to make jravis in python\\DataBase\\NasaDataBase\\Images Used\\" + str(value) + ".jpg"
